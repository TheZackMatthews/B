...
const Location = () => {
  ...
  return (
    <div className="banner-content">
          ...
          <div className="tab-content">
            {selectedTravelMethod === "car" && (
              <div
                ...
                style={{ minHeight: "278.7px" }}
              >
                <p
                  style={{ lineHeight: "1.3" }}
                  data-lineheight="28.6px"
                >
                  By Car
                </p>
                <p>
                  Leavenworth is easily accessible from the west coast via US
                  Highway 2, and the drive through the Cascades has been voted
                  as one of the most scenic drives in the States. The highway is
                  well maintained with frequent pull-outs and rest stops to soak
                  in the scenery or grab a bite. In the winter, the roads are
                  kept clear, though you will want to check the road reports
                ...
                <div>
                  <a
                    ...
                    href="https://goo.gl/maps/MA8zs8WwteQExQrj6"
                  >
                  </a>
                </div>
              </div>
            ...
            {selectedTravelMethod === "bus" && (
              ...
              >
                ...
                <p>
                  ...
                  &nbsp;daily bus service directly to Leavenworth.
                  1-800-366-3830
                </p>
                <p>
                ...
                <p>
                  ...
                  reliable, and cost effective public transportation services
                  that promote citizen access to work, recreation, commerce and
                  public services.
                </p>
                <ul>
                  <li>
            ...
            {selectedTravelMethod === "train" && (
              ...
              >
                ...
                <p>
                  <strong>For Train status</strong>&nbsp;please call (800)
                  872-7245 – (1.800.USA.RAIL)
                </p>
                <p>
                  <strong>For Train Ticket purchases:</strong>
                </p>
                <ul>
                  <li>
                    Icicle Station is an un-staffed station and does not have a
                    quik-trak machine at this time.&nbsp; Tickets can be
                    purchased via a number of ways:
                  </li>
                  <li>
                    Reservations can be made via phone (1.800.872.7245) or on
                    the web&nbsp;
                    <a href="https://www.amtrak.com/">www.amtrak.com</a>
                  </li>
                  <li>
                    Icicle Station Shuttle Service provided by Leavenworth
                    Shuttle (877) 868-7720 or (509) 548-7433
                  </li>
                </ul>
              </div>
            )}
      ...
      <iframe
        src="https://leavenworth.org/lodging-results/hotels-motels/"
        title="Leavenworth Hotel Results"
        height="800px"
        width="90%"
        display="flex"
      ></iframe>
